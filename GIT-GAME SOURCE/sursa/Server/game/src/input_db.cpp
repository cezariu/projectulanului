...
d->GetAccountTable().bChannel, 
	...
	static SInitialItem initialItems[MAIN_RACE_MAX_NUM][11] =
	{
		/* MAIN_RACE_WARRIOR_M */
		{
			{INVENTORY, 0, 1, 19, {APPLY_STR, 12, APPLY_CRITICAL_PCT, 10, APPLY_PENETRATE_PCT, 10, APPLY_ATTBONUS_ORC, 20, APPLY_ATTBONUS_ANIMAL, 20}},								// 2 slot
			{INVENTORY, 1, 1, 3009, {APPLY_STR, 12, APPLY_CRITICAL_PCT, 10, APPLY_PENETRATE_PCT, 10, APPLY_ATTBONUS_ORC, 20, APPLY_ATTBONUS_ANIMAL, 20}},								// 3 slot
			{INVENTORY, 2, 1, 11209, {APPLY_MAX_HP, 2000, APPLY_ATT_GRADE_BONUS, 50, APPLY_STEAL_HP, 10, APPLY_REFLECT_MELEE, 10, APPLY_CAST_SPEED, 20}},					// 2 slot
			{INVENTORY, 3, 1, 12209, {APPLY_HP_REGEN, 30, APPLY_POISON_PCT, 8, APPLY_DODGE, 15, APPLY_ATT_SPEED, 10, APPLY_ATTBONUS_ORC, 20}},								// 1 slot
			{INVENTORY, 4, 1, 13009, {APPLY_IMMUNE_STUN, 1, APPLY_STR, 12, APPLY_BLOCK, 10, APPLY_REFLECT_MELEE, 10, APPLY_ATTBONUS_ORC, 20}},								// 1 slot
			{INVENTORY, 8, 1, 14009, {APPLY_MAX_HP, 2000, APPLY_PENETRATE_PCT, 10, APPLY_STEAL_HP, 10, APPLY_ATTBONUS_ORC, 20, APPLY_ITEM_DROP_BONUS, 20}},					// 1 slot
			{INVENTORY, 9, 1, 15009, {APPLY_MAX_HP, 2000, APPLY_CRITICAL_PCT, 10, APPLY_DODGE, 15, APPLY_ATTBONUS_ANIMAL, 20, APPLY_GOLD_DOUBLE_BONUS, 20}},						// 1 slot
			{INVENTORY, 10, 1, 16009, {APPLY_MAX_HP, 2000, APPLY_CRITICAL_PCT, 10, APPLY_PENETRATE_PCT, 10, APPLY_HP_REGEN, 30, APPLY_ATTBONUS_ANIMAL, 20}},						// 1 slot
		...
		{
			{INVENTORY, 0, 1, 1009, {APPLY_STR, 12, APPLY_CRITICAL_PCT, 10, APPLY_PENETRATE_PCT, 10, APPLY_ATTBONUS_ORC, 20, APPLY_ATTBONUS_ANIMAL, 20}},								// 1 slot
			{INVENTORY, 1, 1, 2009, {APPLY_STR, 12, APPLY_CRITICAL_PCT, 10, APPLY_PENETRATE_PCT, 10, APPLY_ATTBONUS_ORC, 20, APPLY_ATTBONUS_ANIMAL, 20}},								// 2 slot
			{INVENTORY, 2, 1, 19, {APPLY_STR, 12, APPLY_CRITICAL_PCT, 10, APPLY_PENETRATE_PCT, 10, APPLY_ATTBONUS_ORC, 20, APPLY_ATTBONUS_ANIMAL, 20}},								// 2 slot
			{INVENTORY, 3, 1, 11409, {APPLY_MAX_HP, 2000, APPLY_ATT_GRADE_BONUS, 50, APPLY_STEAL_HP, 10, APPLY_REFLECT_MELEE, 10, APPLY_CAST_SPEED, 20}},					// 2 slot
			{INVENTORY, 4, 1, 12349, {APPLY_HP_REGEN, 30, APPLY_POISON_PCT, 8, APPLY_DODGE, 15, APPLY_ATT_SPEED, 10, APPLY_ATTBONUS_ORC, 20}},								// 1 slot
			{INVENTORY, 5, 1, 13009, {APPLY_IMMUNE_STUN, 1, APPLY_STR, 12, APPLY_BLOCK, 10, APPLY_REFLECT_MELEE, 10, APPLY_ATTBONUS_ORC, 20}},								// 1 slot
			{INVENTORY, 9, 1, 14009, {APPLY_MAX_HP, 2000, APPLY_PENETRATE_PCT, 10, APPLY_STEAL_HP, 10, APPLY_ATTBONUS_ORC, 20, APPLY_ITEM_DROP_BONUS, 20}},					// 1 slot
			{INVENTORY, 10, 1, 15009, {APPLY_MAX_HP, 2000, APPLY_CRITICAL_PCT, 10, APPLY_DODGE, 15, APPLY_ATTBONUS_ANIMAL, 20, APPLY_GOLD_DOUBLE_BONUS, 20}},						// 1 slot
			{INVENTORY, 11, 1, 16009, {APPLY_MAX_HP, 2000, APPLY_CRITICAL_PCT, 10, APPLY_PENETRATE_PCT, 10, APPLY_HP_REGEN, 30, APPLY_ATTBONUS_ANIMAL, 20}},						// 1 slot
			{INVENTORY, 12, 1, 17009, {APPLY_POISON_REDUCE, 10, APPLY_ITEM_DROP_BONUS, 20, APPLY_ATTBONUS_ORC, 20, APPLY_ATTBONUS_MILGYO, 20, APPLY_ATTBONUS_ANIMAL, 20}},	// 1 slot
			{INVENTORY, 13, 1, 50187, {0, 10, 0, 0, 0, 0, 0, 0, 0, 0}}
		},
		/* MAIN_RACE_SURA_M */
		{
			{INVENTORY, 0, 1, 19, {APPLY_STR, 12, APPLY_CRITICAL_PCT, 10, APPLY_PENETRATE_PCT, 10, APPLY_ATTBONUS_ORC, 20, APPLY_ATTBONUS_ANIMAL, 20}},								// 2 slot
			{INVENTORY, 1, 1, 11609, {APPLY_MAX_HP, 2000, APPLY_ATT_GRADE_BONUS, 50, APPLY_STEAL_HP, 10, APPLY_REFLECT_MELEE, 10, APPLY_CAST_SPEED, 20}},					// 2 slot
			{INVENTORY, 2, 1, 12489, {APPLY_HP_REGEN, 30, APPLY_POISON_PCT, 8, APPLY_DODGE, 15, APPLY_ATT_SPEED, 10, APPLY_ATTBONUS_ORC, 20}},								// 1 slot
			{INVENTORY, 3, 1, 13009, {APPLY_IMMUNE_STUN, 1, APPLY_STR, 12, APPLY_BLOCK, 10, APPLY_REFLECT_MELEE, 10, APPLY_ATTBONUS_ORC, 20}},								// 1 slot
			{INVENTORY, 4, 1, 14009, {APPLY_MAX_HP, 2000, APPLY_PENETRATE_PCT, 10, APPLY_STEAL_HP, 10, APPLY_ATTBONUS_ORC, 20, APPLY_ITEM_DROP_BONUS, 20}},					// 1 slot
			{INVENTORY, 7, 1, 15009, {APPLY_MAX_HP, 2000, APPLY_CRITICAL_PCT, 10, APPLY_DODGE, 15, APPLY_ATTBONUS_ANIMAL, 20, APPLY_GOLD_DOUBLE_BONUS, 20}},						// 1 slot
			{INVENTORY, 8, 1, 16009, {APPLY_MAX_HP, 2000, APPLY_CRITICAL_PCT, 10, APPLY_PENETRATE_PCT, 10, APPLY_HP_REGEN, 30, APPLY_ATTBONUS_ANIMAL, 20}},							// 1 slot
		...
		/* MAIN_RACE_SHAMAN_W */
		{
			{INVENTORY, 0, 1, 5009, {APPLY_STR, 12, APPLY_CRITICAL_PCT, 10, APPLY_PENETRATE_PCT, 10, APPLY_ATTBONUS_ORC, 20, APPLY_ATTBONUS_ANIMAL, 20}},								// 1 slot
			{INVENTORY, 1, 1, 7009, {APPLY_STR, 12, APPLY_CRITICAL_PCT, 10, APPLY_PENETRATE_PCT, 10, APPLY_ATTBONUS_ORC, 20, APPLY_ATTBONUS_ANIMAL, 20}},								// 1 slot
			{INVENTORY, 2, 1, 11809, {APPLY_MAX_HP, 2000, APPLY_ATT_GRADE_BONUS, 50, APPLY_STEAL_HP, 10, APPLY_REFLECT_MELEE, 10, APPLY_CAST_SPEED, 20}},					// 2 slot
			{INVENTORY, 3, 1, 12629, {APPLY_HP_REGEN, 30, APPLY_POISON_PCT, 8, APPLY_DODGE, 15, APPLY_ATT_SPEED, 10, APPLY_ATTBONUS_ORC, 20}},								// 1 slot
			{INVENTORY, 4, 1, 13009, {APPLY_IMMUNE_STUN, 1, APPLY_STR, 12, APPLY_BLOCK, 10, APPLY_REFLECT_MELEE, 10, APPLY_ATTBONUS_ORC, 20}},								// 1 slot
			{INVENTORY, 5, 1, 14009, {APPLY_MAX_HP, 2000, APPLY_PENETRATE_PCT, 10, APPLY_STEAL_HP, 10, APPLY_ATTBONUS_ORC, 20, APPLY_ITEM_DROP_BONUS, 20}},					// 1 slot
			{INVENTORY, 6, 1, 15009, {APPLY_MAX_HP, 2000, APPLY_CRITICAL_PCT, 10, APPLY_DODGE, 15, APPLY_ATTBONUS_ANIMAL, 20, APPLY_GOLD_DOUBLE_BONUS, 20}},						// 1 slot
			{INVENTORY, 8, 1, 16009, {APPLY_MAX_HP, 2000, APPLY_CRITICAL_PCT, 10, APPLY_PENETRATE_PCT, 10, APPLY_HP_REGEN, 30, APPLY_ATTBONUS_ANIMAL, 20}},							// 1 slot
			{INVENTORY, 9, 1, 17009, {APPLY_POISON_REDUCE, 10, APPLY_ITEM_DROP_BONUS, 20, APPLY_ATTBONUS_ORC, 20, APPLY_ATTBONUS_MILGYO, 20, APPLY_ATTBONUS_ANIMAL, 20}},	// 1 slot
			{INVENTORY, 10, 1, 50187, {0, 10, 0, 0, 0, 0, 0, 0, 0, 0}},
			{INVENTORY, 0, 0, 0, {0, 10, 0, 0, 0, 0, 0, 0, 0, 0}}
