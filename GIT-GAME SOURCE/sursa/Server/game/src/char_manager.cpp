...
void CHARACTER_MANAGER::SetEventStatus(const WORD eventID, const bool eventStatus, const int endTime)
{
	...
	const std::map<BYTE, std::pair<DWORD, DWORD>> m_eventText = {
		//Here
		{BONUS_EVENT,{2051,2052}},
		{DOUBLE_BOSS_LOOT_EVENT,{2053,2054}},
		{DOUBLE_METIN_LOOT_EVENT,{2055,2056}},
		{DOUBLE_MISSION_BOOK_EVENT,{2057,2058}},
		{DUNGEON_COOLDOWN_EVENT,{2059,2060}},
		{DUNGEON_TICKET_LOOT_EVENT,{2061,2062}},
		{MOONLIGHT_EVENT,{2063,2064}},
	};
