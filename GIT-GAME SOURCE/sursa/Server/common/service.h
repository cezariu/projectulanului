...
#endif
#define ENABLE_ANTI_EXP_SYSTEM //Enables or disables Anti-Exp Ring & Exp Bottle in server side.
#ifdef ENABLE_ANTI_EXP_SYSTEM //Enables or disables Exp Bottle feature in server side.
#define ANTIEXP_RING_ID 71550 //ID of Anti-Exp Ring. It is needed to be changed in python too!
#define ENABLE_EXP_BOTTLE_FEATURE

#ifdef ENABLE_EXP_BOTTLE_FEATURE
#define EXP_BOTTLE_STORAGE_LIMIT 2000000000 //Capacity limit of Exp Bottle.
#define EXP_BOTTLE_ID 71551 //ID of Exp Bottle. It is needed to be changed in python too!
#endif
#endif