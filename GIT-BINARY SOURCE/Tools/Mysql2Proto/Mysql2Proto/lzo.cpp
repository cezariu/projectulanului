...
*/
	...
	iOutLen = LZ4_compress_default((const char*)m_pbIn, (char*)pbBuffer, m_pHeader->dwRealSize, LZ4_compressBound(m_pHeader->dwRealSize));
	if (iOutLen < 1) {
		fprintf(stderr, "LZ4: compress_default failed!\n");
		return false;
	}
