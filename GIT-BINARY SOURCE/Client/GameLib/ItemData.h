...
class CItemData
{
	public:
		...
		enum EUseSubTypes
		{
			...
			USE_ATTR_SASH_REMOVE,
#endif
#ifdef ENABLE_RUNE_SYSTEM
			USE_RUNE_PERC_CHARGE,
#endif
...
#pragma pack(pop)
	...
	public:
		...
		bool IsFilterRefineItem();
		bool IsFilterBook();
		bool IsFilterEnchant();
		bool IsFilterReinforce();
		bool IsFilterGiftBox();
		bool IsFilterYang();
#endif
		/////
		...
		void AssignLocaleName(const std::string& name);
#endif
#ifdef INGAME_WIKI
	public:
...
#ifdef ENABLE_ACCE_SYSTEM
	protected:
		D3DXVECTOR3 m_itemScale[NRaceData::JOB_MAX_NUM][NRaceData::SEX_MAX_NUM];

	public:
		bool GetItemScale(uint8_t job, uint8_t sex, D3DXVECTOR3& t);
		void SetItemScale(uint8_t job, uint8_t sex, float x, float y, float z);
#endif
