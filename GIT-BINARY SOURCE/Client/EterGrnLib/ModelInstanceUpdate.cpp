...
#ifdef ENABLE_FPS
void CGrannyModelInstance::Update(DWORD dwAniFPS, DWORD minFPS, DWORD maxFPS)
#else
...
#endif
{
	...
	const DWORD c_dwCurUpdateFrame = (DWORD)(GetLocalTime() * maxFPS);
	const DWORD ANIFPS_STEP = maxFPS / dwAniFPS;
...
#endif
	GrannyFreeCompletedModelControls(m_pgrnModelInstance);//lag and freeze fix
