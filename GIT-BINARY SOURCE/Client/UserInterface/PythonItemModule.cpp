...
void initItem()
{
	...
	PyModule_AddIntConstant(poModule, "EQUIPMENT_STOLE", c_Equipment_Stole);
	PyModule_AddIntConstant(poModule, "COSTUME_TYPE_STOLE",		CItemData::COSTUME_STOLE);
#endif
	...
	PyModule_AddIntConstant(poModule, "USE_ADD_ATTR_COSTUME1", CItemData::USE_ADD_ATTR_COSTUME1);
	PyModule_AddIntConstant(poModule, "USE_ADD_ATTR_COSTUME2", CItemData::USE_ADD_ATTR_COSTUME2);
#endif
	...
	PyModule_AddIntConstant(poModule, "APPLY_ATTBONUS_IRR_SPADA", CItemData::APPLY_ATTBONUS_IRR_SPADA);
	PyModule_AddIntConstant(poModule, "APPLY_ATTBONUS_IRR_SPADONE", CItemData::APPLY_ATTBONUS_IRR_SPADONE);
	PyModule_AddIntConstant(poModule, "APPLY_ATTBONUS_IRR_PUGNALE", CItemData::APPLY_ATTBONUS_IRR_PUGNALE);
	PyModule_AddIntConstant(poModule, "APPLY_ATTBONUS_IRR_FRECCIA", CItemData::APPLY_ATTBONUS_IRR_FRECCIA);
	PyModule_AddIntConstant(poModule, "APPLY_ATTBONUS_IRR_VENTAGLIO", CItemData::APPLY_ATTBONUS_IRR_VENTAGLIO);
	PyModule_AddIntConstant(poModule, "APPLY_ATTBONUS_IRR_CAMPANA", CItemData::APPLY_ATTBONUS_IRR_CAMPANA);
	PyModule_AddIntConstant(poModule, "APPLY_RESIST_MEZZIUOMINI", CItemData::APPLY_RESIST_MEZZIUOMINI);
	PyModule_AddIntConstant(poModule, "APPLY_DEF_TALISMAN", CItemData::APPLY_DEF_TALISMAN);
	PyModule_AddIntConstant(poModule, "APPLY_ATTBONUS_FORT_ZODIAC", CItemData::APPLY_ATTBONUS_FORT_ZODIAC);
	...
	PyModule_AddIntConstant(poModule, "APPLY_PARTY_DROPEXP", CItemData::APPLY_PARTY_DROPEXP);
#endif
#ifdef ENABLE_SEALBIND_SYSTEM
	...
	PyModule_AddIntConstant(poModule, "USE_DS_ENCHANT", CItemData::USE_DS_ENCHANT);
#endif
	PyModule_AddIntConstant(poModule, "APPLY_PVM_CRITICAL_PCT", CItemData::APPLY_PVM_CRITICAL_PCT);
#ifdef ENABLE_COSTUME_PET
	PyModule_AddIntConstant(poModule, "COSTUME_PET_SKIN", CItemData::COSTUME_PET_SKIN);
#endif
#ifdef ENABLE_COSTUME_MOUNT
	PyModule_AddIntConstant(poModule, "COSTUME_MOUNT_SKIN", CItemData::COSTUME_MOUNT_SKIN);
#endif
#ifdef ENABLE_COSTUME_EFFECT
	PyModule_AddIntConstant(poModule, "COSTUME_EFFECT_BODY", CItemData::COSTUME_EFFECT_BODY);
	PyModule_AddIntConstant(poModule, "COSTUME_EFFECT_WEAPON", CItemData::COSTUME_EFFECT_WEAPON);
#endif
#ifdef ENABLE_DS_RUNE
	PyModule_AddIntConstant(poModule, "APPLY_RUNE_MONSTERS", CItemData::APPLY_RUNE_MONSTERS);
#endif
#ifdef ENABLE_RUNE_SYSTEM
	PyModule_AddIntConstant(poModule, "RUNE_SLOT1", CItemData::RUNE_SLOT1);
	PyModule_AddIntConstant(poModule, "RUNE_SLOT7", CItemData::RUNE_SLOT7);
	PyModule_AddIntConstant(poModule, "USE_RUNE_PERC_CHARGE", CItemData::USE_RUNE_PERC_CHARGE);
#endif
#ifdef ENABLE_NEW_USE_POTION
	PyModule_AddIntConstant(poModule, "USE_NEW_POTIION", CItemData::USE_NEW_POTIION);
#endif
#ifdef ENABLE_STOLE_COSTUME
	PyModule_AddIntConstant(poModule, "USE_ENCHANT_STOLE", CItemData::USE_ENCHANT_STOLE);
#endif
#ifdef ENABLE_NEW_COMMON_BONUSES
	PyModule_AddIntConstant(poModule, "APPLY_DOUBLE_DROP_ITEM", CItemData::APPLY_DOUBLE_DROP_ITEM);
	PyModule_AddIntConstant(poModule, "APPLY_IRR_WEAPON_DEFENSE", CItemData::APPLY_IRR_WEAPON_DEFENSE);
#endif
	PyModule_AddIntConstant(poModule, "APPLY_DESIGN_1", CItemData::APPLY_DESIGN_1);
	PyModule_AddIntConstant(poModule, "USE_FISH", CItemData::USE_FISH);
	PyModule_AddIntConstant(poModule, "APPLY_FISHING_RARE", CItemData::APPLY_FISHING_RARE);
#ifdef ENABLE_ITEMSHOP_ITEM
	PyModule_AddIntConstant(poModule, "ITEM_TYPE_ISHOP", CItemData::ITEM_TYPE_ISHOP);
#endif
}
