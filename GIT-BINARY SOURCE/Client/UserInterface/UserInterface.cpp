...
static std::wstring G_ROOT = L"packrootw2";
static std::wstring G_DOWNLOAD = L"http://38.242.226.68:42531";
...
{ \
   ...
   oss << x; \
   MessageBox(NULL, oss.str().c_str(), "ENERGY2", MB_ICONSTOP); \
}
...
bool PackInitialize(const char * c_pszFolder)
{
	...
	if (stat( "D:\\ymir work", &st) == 0 ) {
		MessageBox(NULL, "Please remove the folder D:\Ymir Work!", "RUBRIA", MB_ICONSTOP);
		return false;
	}
...
//#ifdef ENABLE_BLOCK_MULTIFARM
//	if (isHypervisor() != 0) {
//		MessageBox(NULL, "You cannot play from Virtual Machines!", "ENERGY2", MB_ICONSTOP);
//		goto Clean;
//	}
//#endif
