...
PyObject * chrCreateInstance(PyObject* poSelf, PyObject* poArgs)
{
	...
	if (PyTuple_Size(poArgs)==2)
	{
		...
		kCreateData.m_bHasBlockedExp = 0;
#endif
...
#ifdef ENABLE_ANTI_EXP_SYSTEM
PyObject* chrHasBlockedExp(PyObject* poSelf, PyObject* poArgs)
{
	int iVirtualID;
	if (!PyTuple_GetInteger(poArgs, 0, &iVirtualID))
		return Py_BuildException();
	...
	return Py_BuildValue("i", pInstance->HasBlockedExp());
}
#endif
...
#endif
#ifdef ENABLE_ANTI_EXP_SYSTEM
		{ "HasBlockedExp",					chrHasBlockedExp,					METH_VARARGS },
#endif
		{ NULL,								NULL,								NULL		 },
	};
