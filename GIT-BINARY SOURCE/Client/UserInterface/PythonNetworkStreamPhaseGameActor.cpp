...
bool CPythonNetworkStream::RecvCharacterAppendPacket()
{
	...
	kNetActorData.m_bHasBlockedExp = 0;
#endif
...
#ifdef ENABLE_ANTI_EXP_SYSTEM
		kNetActorData.m_bHasBlockedExp = chrInfoPacket.bHasBlockedExp;
#endif
...
#ifdef ENABLE_ANTI_EXP_SYSTEM
	kNetActorData.m_bHasBlockedExp = chrAddPacket.bHasBlockedExp;
#endif
...
#ifdef ENABLE_ANTI_EXP_SYSTEM
	kNetUpdateActorData.m_bHasBlockedExp = chrUpdatePacket.bHasBlockedExp;
#endif
