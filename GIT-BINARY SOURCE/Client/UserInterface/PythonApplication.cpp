...
void CPythonApplication::SetAppFPS(BYTE index)
{
	...
	/* BAD IDEA
	c_fDefaultCameraRotateSpeed = fps * (1.5f / 60.0f);
	c_fDefaultCameraPitchSpeed = fps*(1.5f/60.0f);
	c_fDefaultCameraZoomSpeed = fps*(0.05f/60.0f);
	m_fCameraRotateSpeed = c_fDefaultCameraRotateSpeed;
	m_fCameraPitchSpeed = c_fDefaultCameraPitchSpeed;
	m_fCameraZoomSpeed = c_fDefaultCameraZoomSpeed;
	*/
...
bool LoadLocaleData(const char* localePath)
{
	...
	snprintf(szChestDrop, sizeof(szChestDrop), "data/items/chest_drop");
