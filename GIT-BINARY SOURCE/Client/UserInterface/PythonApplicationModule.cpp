...
#ifdef ENABLE_FPS
	PyModule_AddIntConstant(poModule, "ENABLE_FPS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_FPS", 0);
#endif
...
PyModule_AddIntConstant(poModule, "ENABLE_CLIENT_OPTIMIZATION", 0);
	...
	PyModule_AddIntConstant(poModule, "ENABLE_CLIENT_VERSION_CHECK", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CLIENT_VERSION_CHECK", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_ANTI_EXP_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ANTI_EXP_SYSTEM", 0);
#endif
