...
CPythonSkill::CPythonSkill()
{
	...
	m_SkillWeaponTypeIndexMap.insert(std::make_pair(std::string("MOUNT_SPEAR"), CItemData::WEAPON_MOUNT_SPEAR));
#ifdef ENABLE_WOLFMAN_CHARACTER
	m_SkillWeaponTypeIndexMap.insert(std::make_pair(std::string("CLAW"), CItemData::WEAPON_CLAW));
#endif
...
#ifdef ENABLE_WOLFMAN_CHARACTER
	m_PathNameMap.insert(std::make_pair(std::string("78SKILL"), std::string("78skill")));
	m_PathNameMap.insert(std::make_pair(std::string("WOLFMAN"), std::string("wolfman")));
#endif
