...
UPDATE_2_5 = 60
WINDOW_WIDTH			= 188
WINDOW_HEIGHT			= 380 + UPDATE_2_5 - 22
PATTERN_WINDOW_WIDTH	= WINDOW_WIDTH - 22
PATTERN_WINDOW_HEIGHT	= WINDOW_HEIGHT - 46 - 64

PATTERN_X_COUNT = (PATTERN_WINDOW_WIDTH - 32) / 16
PATTERN_Y_COUNT = (PATTERN_WINDOW_HEIGHT - 32) / 16 - 64
	...
	(
		{
			...
			(
				...
				## main slot bg
				{
					...
					(
						## regist slot
						{
								...
								"slot" : ( {"index":0, "x":6, "y":6, "width":32, "height":32}, )
						},
					),
				},
				## Item Slot
...

				{
					"name" : "OpenController",
					"type" : "sliderbar",
					"x" : (WINDOW_WIDTH - 175) / 2,
					"y" : 343 + UPDATE_2_5 - 64 + 6,
				},
