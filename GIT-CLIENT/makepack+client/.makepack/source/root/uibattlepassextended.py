	...
	def __LoadWindow(self):
		...
		try:
			...
			self.missionNameDict = {
				...
				20 : {"name" : uiscriptlocale.EXTENDET_BATTLE_PASS_TYPENAME_21, "desc" : uiscriptlocale.EXTENDET_BATTLE_PASS_TYPENAME_21_DESC_1, "desc_non_condition" : uiscriptlocale.EXTENDET_BATTLE_PASS_TYPENAME_21_DESC_2},
			}
			self.mapNameDict = {
