...
class Interface(object):
	...
	def __MakeWindows(self):
		...
		if app.WJ_ENABLE_TRADABLE_ICON or app.__BL_CHEST_DROP_INFO__:
	...
	if app.__BL_CHEST_DROP_INFO__:
		def OpenChestDropWindow(self, itemVnum, isMain, slotPos, slotWindow):
			if self.wndChestDropInfo:
				self.wndChestDropInfo.Open(itemVnum, isMain, slotPos, slotWindow)
