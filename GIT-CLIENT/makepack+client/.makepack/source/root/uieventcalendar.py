...
class ImageBoxSpecial(ui.ImageBox):
	...
	def __init__(self, isMiniIcon = False):
		...
		if isMiniIcon:
			...
			self.SAFE_SetStringEvent("MOUSE_LEFT_DOWN",self.OnClickEventIcon)
...
class EventCalendarWindow(ui.BoardWithTitleBar):
	...
	def __CalculateTime(self, eventIndex, startTimeText, endTimeText, endTime):
		if endTimeText == "2022-08-20 03:00:00" or endTimeText == "1970-01-01 02:00:00" or endTimeText == "1970-01-01 01:00:00" or endTimeText == "1970-01-01 00:00:00" or endTimeText == "":
