...
class CreateCharacterWindow(ui.Window):
	...
	def Open(self):
		...
		if app.ENABLE_WOLFMAN_CHARACTER:
			pythonScriptLoader.LoadScriptFile(dlgBoard, "uiscript/createcharacterwindow2.py")
		else:
			pythonScriptLoader.LoadScriptFile(dlgBoard, "uiscript/createcharacterwindow1.py")
