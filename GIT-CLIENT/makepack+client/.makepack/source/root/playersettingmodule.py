...
def LoadGameEffect():
	...
	if app.ENABLE_EXTENDED_BATTLE_PASS:
		chrmgr.RegisterCacheEffect(chrmgr.EFFECT_BP_NORMAL_MISSION_COMPLETED , "", "d:/ymir work/effect/battlepass/normal_mission_complete.mse")
		chrmgr.RegisterCacheEffect(chrmgr.EFFECT_BP_PREMIUM_MISSION_COMPLETED , "", "d:/ymir work/effect/battlepass/premium_mission_complete.mse")
		chrmgr.RegisterCacheEffect(chrmgr.EFFECT_BP_EVENT_MISSION_COMPLETED , "", "d:/ymir work/effect/battlepass/event_mission_complete.mse")
		chrmgr.RegisterCacheEffect(chrmgr.EFFECT_BP_NORMAL_BATTLEPASS_COMPLETED , "", "d:/ymir work/effect/battlepass/normal_battlepass_complete.mse")
		chrmgr.RegisterCacheEffect(chrmgr.EFFECT_BP_PREMIUM_BATTLEPASS_COMPLETED , "", "d:/ymir work/effect/battlepass/premium_battlepass_complete.mse")
		chrmgr.RegisterCacheEffect(chrmgr.EFFECT_BP_EVENT_BATTLEPASS_COMPLETED , "", "d:/ymir work/effect/battlepass/event_battlepass_complete.mse")
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+20, "", "t_work/vip5.mse")
	net.RegisterEmoticonString("(vIpSyStEmMeTiN2@Tupeu1X3SATxUxPxExU)")
	
	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+21, "", "t_work/mister5.mse")
	net.RegisterEmoticonString("(vIpSyStEmMeTiN2@Tupeu11X3SATxUxPxExUMister)")
	
	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+22, "", "t_work/miss5.mse")
	net.RegisterEmoticonString("(vIpSyStEmMeTiN2@Tupeu11X3SATxUxPxExUMiss)")
	
	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+23, "", "t_work/moderator5.mse")
