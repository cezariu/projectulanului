...
#endif
#if defined(ENABLE_SUPPORT_SYSTEM)
...
#ifdef TEXTS_IMPROVEMENT
		ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1380, "");
#endif
	}
	else
	{
...
#ifdef TEXTS_IMPROVEMENT
			ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1376, "");
			ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1377, "%d", CBattlePassManager::instance().GetNormalBattlePassID());
			ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1378, "%d", std::atoi(row_registred[0]));
			ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1379, "%d#%d", std::atoi(row_compledet[0]), std::atoi(row_registred[0]));
			ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1376, "");
#endif
		}
	}
...
#ifdef TEXTS_IMPROVEMENT
		ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1381, "");
#endif
	}
	else
	{
...
#ifdef TEXTS_IMPROVEMENT
			ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1376, "");
			ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1383, "%d", CBattlePassManager::instance().GetPremiumBattlePassID());
			ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1384, "%d", std::atoi(row_registred[0]));
			ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1385, "%d#%d", std::atoi(row_compledet[0]), std::atoi(row_registred[0]));
			ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1376, "");
#endif
		}
	}
...
#ifdef TEXTS_IMPROVEMENT
		ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1382, "");
#endif
	}
	else
	{
...
#ifdef TEXTS_IMPROVEMENT
			ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1376, "");
			ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1386, "%d", CBattlePassManager::instance().GetEventBattlePassID());
			ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1387, "%d", std::atoi(row_registred[0]));
			ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1388, "%d#%d", std::atoi(row_compledet[0]), std::atoi(row_registred[0]));
			ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1376, "");
#endif
		}
	}
...
ACMD(do_battlepass_set_mission)
{
	...
	{
#ifdef TEXTS_IMPROVEMENT
		ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1389, "");
		ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1390, "");
		ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1391, "");
		ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1392, "");
#endif
		return;
	}
	...
	if (mission_type == 0){
#ifdef TEXTS_IMPROVEMENT
		ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1395, "%d#%d", mission_index, battlepass_type);
#endif
		return;
	} else {
...
ACMD(do_battlepass_premium_activate)
{
	...
	{
#ifdef TEXTS_IMPROVEMENT
		ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1396, "");
#endif
		return;
	}
...
#ifdef TEXTS_IMPROVEMENT
			tch->ChatPacketNew(CHAT_TYPE_NOTICE, 1397, "");
			ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1398, "%s", tch->GetName());
#endif
		}
		if (value == 0)
		{
...
#ifdef TEXTS_IMPROVEMENT
			tch->ChatPacketNew(CHAT_TYPE_NOTICE, 1399, "");
			ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1400, "%s", tch->GetName());
#endif
		}
	}
	else
...
#ifdef TEXTS_IMPROVEMENT
			ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1401, "");
#endif
		}
		if (value == 0)
		{
			...
			CBattlePassManager::instance().BattlePassRequestOpen(ch, false);
#ifdef TEXTS_IMPROVEMENT
			ch->ChatPacketNew(CHAT_TYPE_NOTICE, 1402, "");
#endif
		}
	}
}
