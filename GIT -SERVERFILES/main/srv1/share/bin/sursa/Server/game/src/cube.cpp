...
void Cube_open (LPCHARACTER ch)
{
	...
	if (ch->IsCubeOpen())
	{
		...
		ch->ChatPacketNew(CHAT_TYPE_INFO, 504, "");
#endif
		return;
	}
	...
	{
#ifdef TEXTS_IMPROVEMENT
		ch->ChatPacketNew(CHAT_TYPE_INFO, 697, "");
#endif
		return;
	}
...
bool Cube_make (LPCHARACTER ch)
{
	...
	{
#ifdef TEXTS_IMPROVEMENT
		ch->ChatPacketNew(CHAT_TYPE_INFO, 506, "");
#endif
		return false;
	}
	...
	{
#ifdef TEXTS_IMPROVEMENT
		ch->ChatPacketNew(CHAT_TYPE_INFO, 505, "");
#endif
		return false;
	}
	...
	{
#ifdef TEXTS_IMPROVEMENT
		ch->ChatPacketNew(CHAT_TYPE_INFO, 522, "");
#endif
	...
	{
#ifdef TEXTS_IMPROVEMENT
		ch->ChatPacketNew(CHAT_TYPE_INFO, 523, "");
#endif
