...
class CHARACTER : public CEntity, public CFSM, public CHorseRider
{
	...
	public:
		...
		bool				HasBlockedExp() const { return m_bHasBlockedExp ? true : false; }
		void				SetBlockExpValue(short val) { m_bHasBlockedExp = val; }
		short				GetBlockExpValue() const { return m_bHasBlockedExp; }
#endif
		//////////////////////////////////////////////////////////////////////////////////
...
//		bool			IsPet() const		{ return m_bCharType == CHAR_TYPE_PET; }
	...
	public:
		...
		bool			WarpToPID(DWORD dwPID, bool checkWarp = false);
...
protected:
	...
	private:
	 ...
	 public:
		 constexpr static uint64_t GuildTokenHash = 84593781371;
