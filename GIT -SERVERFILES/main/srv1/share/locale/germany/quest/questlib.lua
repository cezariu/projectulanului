dofile(get_locale_base_path().."/quest/libraries/dungeonlib.lua");
dofile(get_locale_base_path().."/quest/libraries/Global.lua");
dofile(get_locale_base_path().."/quest/libraries/ResetScrollLib.lua");
dofile(get_locale_base_path().."/quest/libraries/SkillNameList.lua");
dofile(get_locale_base_path().."/quest/libraries/WarpLib.lua");
dofile(get_locale_base_path().."/quest/libraries/TeleportRingLib.lua");
CONFIRM_NO = 0
CONFIRM_YES = 1
CONFIRM_OK = 1
CONFIRM_TIMEOUT = 2
...
special.active_skill_list = {
	{
		{ 1, 2, 3, 4, 5, 6, 236},
		{ 16, 17, 18, 19, 20, 21, 240},
	},
	{
		{31, 32, 33, 34, 35, 36, 237},
		{46, 47, 48, 49, 50, 51, 241},
	},
	{
		{61, 62, 63, 64, 65, 66, 238},
		{76, 77, 78, 79, 80, 81, 242},
	},
	{
		{91, 92, 93, 94, 95, 96, 239},
		{106, 107, 108, 109, 110, 111, 243},
	},
}
...
--- NEW MYSQL_QUERY FUNCTION
function execute_query(db, query)
	local PROGRAM_PATH = "/Server/main/srv1/mysql_query/"
...
--[[
	Returns:
		The totally randomized and shuffled version of a table.
		Example:
				local table_ex = {
					[1] = "lol",
					[2] = "asd",
	...
	Since it is random, some values may be the same as before.
]]
