quest skillnpc begin
    state start begin
            when 9013.chat."G SKILLS" begin
                say_title("Legendary Merchant")
                say("I can make all of your skills")
                say("and passives G1.")
				...
				pc.set_skill_level(221 ,30)
				pc.set_skill_level(222 ,30)
				pc.set_skill_level(223 ,30)
				pc.set_skill_level(224 ,30)
				pc.set_skill_level(225 ,30)
				pc.set_skill_level(226 ,30)
				pc.set_skill_level(227 ,30)
				pc.set_skill_level(228 ,30)
				pc.set_skill_level(236 ,30)
