...
v_adminPagePassword='FASHF2jbdAFSAAA'						#adminpage_password
v_serverHostname='localhost'								#host for sql connections
v_serverUserPass='e2user! e2pass!'							#user&pwd for sql connection
v_serverData="%s %s" % (v_serverHostname, v_serverUserPass)	#host, user and pwd for db sql connections
v_dbHostname='localhost'									#default hostname for db
...
M2CONFIG_SRV1 = {
	"db": {
		"general": (
			...
			("PLAYER_DELETE_LEVEL_LIMIT = %u", (75)),
	...
	"core": {
		M2TYPE.AUTH: (
			...
			("define_client_version: %s", ("523759835")),
		),
		M2TYPE.CORE: (
...
COMMONCHAN=(
	{
		...
		"maps" : "3 23 43 25 26 215 218 210 353 354 357 61 62 63 64 65 67 68 69 70 302 304 305 306 307 308 309 310 311 312",
	},
	{
		"name": "core2",
		"type": M2TYPE.CORE,
		...
		"p2p_port": PORT.RANDOM,
		"config": M2CONFIG_SRV1["core"],
		"maps" : "219 355 27 217 66 216 208 212 351 352 209 71 72 73 104 303 301 313 314 315",
	},
)
...
CHAN99=(
	{
		...
		"p2p_port": PORT.RANDOM,
		"config": M2CONFIG_SRV1["core"],
		"maps" : "1 21 41 81 103 105 110 111 113 356",
	},
)
